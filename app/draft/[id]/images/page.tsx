  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <StepIndicator currentStep="images" />
        <div className="p-6">Loading images...</div>
      </div>
    )
  }
  ...
  if (imageUrls.length === 0) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <StepIndicator currentStep="images" />
        <div className="p-6">
          <p>No images found. Go back to <Link href={`/draft/${id}`} className="text-blue-600 hover:underline">draft</Link> page.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Generated Logos</h1>
        <div>
          <Link href={`/draft/${id}`} className="text-blue-600 hover:underline mr-4">
            Back to Draft
          </Link>
